...
const statusConfig = {
  ...
  IMPORTED: { label: 'Imported', variant: 'secondary' as const },
  ...
  PENDING_APPROVAL: { label: 'Approval Pending', variant: 'warning' as const },
  ...
  COMPLETED_CLEAR: { label: 'Clear', variant: 'success' as const },
  COMPLETED_WITH_CONCERN: { label: 'Completed With Concern', variant: 'warning' as const },
  CONSENT_PENDING: { label: 'Consent Pending', variant: 'warning' as const },
  INITIATED: { label: 'Initiated', variant: 'warning' as const },
  EXPIRED: { label: 'Expired', variant: 'destructive' as const },
  NOT_SCREENED: { label: 'Not Screened', variant: 'outline' as const },
