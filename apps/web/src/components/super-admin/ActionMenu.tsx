...
export type ActionMenuItem = {
  ...
  onSelect?: () => void;
  href?: string;
  /** Hide from menu entirely */
  hidden?: boolean;
  /** Show but not clickable */
  disabled?: boolean;
...
/**
 * Enterprise three-dot (⋮) contextual action menu.
 * Renders via portal so table overflow does not clip the panel.
 */
...
/** Convenience wrapper for PageHeader / card corner placement */
