...
export const FREE_TRIAL_TERMS_ITEMS: Array<{ title: string; body: string }> = [
  {
    title: 'Trial Scope',
    body: 'The BesTal Free Trial allows your organization to engage a selected engineer for up to 10 working hours at no charge to evaluate technical skills, communication, and overall suitability for your requirements.',
  },
  {
  ...
  },
  {
    ...
    body: 'The Free Trial is limited to a maximum of 10 hours per engineer unless otherwise agreed in writing by BesTal.',
  },
  {
  ...
  },
  {
    ...
    body: 'Any work requested beyond the 10-hour Free Trial must be performed under a paid engagement arranged through BesTal.',
  },
  {
