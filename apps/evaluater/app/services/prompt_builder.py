...
RESPONSE_SCHEMA = {
    ...
    "evaluation_type": "string — e.g. Technical Interview|System Design|Coding Assessment|Client Fit|Overall",
    ...
    "recommendation": "string — e.g. Strong Hire|Hire|Hold|No Hire|Needs Follow-up",
...
- recommendation should be a clear hiring recommendation derived from the document.
