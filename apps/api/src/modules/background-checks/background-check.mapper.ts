...
export function mapBackgroundCheckToDto(
  ...
  return {
    ...
    candidateSourceCandidateId: record.candidate.sourceCandidateId ?? null,
    ...
    idCheckStatus: record.idCheckStatus,
    addressCheckStatus: record.addressCheckStatus,
    employmentCheckStatus: record.employmentCheckStatus,
    educationCheckStatus: record.educationCheckStatus,
    criminalCheckStatus: record.criminalCheckStatus,
    referenceCheckStatus: record.referenceCheckStatus,
